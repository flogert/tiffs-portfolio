          ...
          <div className="max-w-2xl mx-auto bg-background/60 backdrop-blur-md rounded-2xl p-2 shadow-xl border border-primary/10">
            <div className="bg-white/50 rounded-xl overflow-hidden">
              <div className="p-6 bg-primary/5 border-b border-primary/10">
                <h4 className="text-2xl font-serif font-bold text-primary mb-2">We'd love to join you!</h4>
                <p className="text-muted-foreground text-sm">Inquire here to receive a free estimate.</p>
              </div>
              <iframe 
